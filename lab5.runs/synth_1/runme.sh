...
HD_PWD='C:/Users/flori/OneDrive/Desktop/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_mip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_mip.tcl
