...
HD_PWD='C:/Users/flori/OneDrive/Desktop/lab5/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_mip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_mip.tcl -notrace
